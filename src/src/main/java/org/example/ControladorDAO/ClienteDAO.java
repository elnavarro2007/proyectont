...
public class ClienteDAO {
    ...
    public static boolean insertarCliente(Cliente cliente) {
        try (Connection connection = getConnection();
             PreparedStatement ps = connection.prepareStatement("INSERT INTO cliente (dni,nombre,apellidos,telefono,correo,password) VALUES (?,?,?,?,?,?)")) {
    ...
    public static ArrayList<Cliente> verCliente() {
        ...
        try (Connection connection = getConnection();
             PreparedStatement ps = connection.prepareStatement("SELECT * FROM cliente where nombre != 'admin'")) {
    ...
    public static boolean actualizarCliente(Cliente cliente){
        ...
        try (Connection connection = getConnection();
             PreparedStatement ps = connection.prepareStatement("UPDATE cliente SET telefono = ?, correo = ?, password = ? WHERE dni = ?")) {
